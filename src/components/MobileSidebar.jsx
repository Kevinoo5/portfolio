...
const MobileSidebar = ({ showMenu, toggleMenu }) => {
    return (
        <div className={`fixed text-white flex flex-col items-center justify-center z-20 h-lvh right-0 w-1/2 bg-gradient-to-tr from-slate-900 to-blue-900 rounded-l-2xl transition-transform duration-700 transform ${showMenu ? 'translate-x-0' : 'translate-x-full'}`}>
